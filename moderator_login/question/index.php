    ...
    <nav class="navbar navbar-inverse navbar-fixed-top">
      <div class="container-fluid">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="../index.php">Question</a>
        </div>
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          ...
          <div class="form-group">
					  <label for="text">option-5</label>
					  <input type="text" class="form-control"  name="op5"  placeholder="Enter option-5">
					</div>
					<div class="form-group">
					  <label for="text">option-6</label>
					  <input type="text" class="form-control" name="op6"  placeholder="Enter option-6">
					</div>

					<div class="form-group">
					  <label for="text">option-7</label>
					  <input type="text" class="form-control"  name="op7"  placeholder="Enter option-7">
					</div>

					<div class="form-group">
					  <label for="text">option-8</label>
					  <input type="text" class="form-control"  name="op8" id="email" placeholder="Enter option-8">
					</div>
					<div class="form-group">
