...
<form name="form1" method="post" action="commentmod2.php" onSubmit="return validation()">
...
mysqli_query($conn,"insert into commenttable2 values ('$name','$_POST[message]')");

 }



$select= mysqli_query($conn,"select * from commenttable2");
