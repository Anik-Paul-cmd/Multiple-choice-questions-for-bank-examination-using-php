...
<head>
 ...
 <?php
    ...
    if(isset($_POST['sign_up']))
    {
		...
		$moderatorresult=$con->serach_moderatoremail($email);
		...
		elseif(mysqli_num_rows($moderatorresult)>0 )
        {
            ?>
            <script>
            alert("This email account is only for moderator");
            </script>
            <?php
        }
                    ...
                    <div class="signup-form">
                        ...
                        <form method="POST"  class="register-form" id="register-form">
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" name="c_password"  placeholder="Repeat your password"/>
                            </div>
                            ...
                            <div class="form-group form-button">
                                <input type="submit" name="sign_up"  class="form-submit" value="Register"/>
                            </div>
                        </form>
                    </div>
