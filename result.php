...
<div class="container">
    ...
    <div id="home" class="tab-pane fade in active">
	  ...
	  <center><button type="button" class="btn btn-primary" data-toggle="tab" href="#select" >Your result</button></center>
	   ...
	   <div id="select" class="tab-pane fade">
		  ...
		  {  ?>
			<option value="<?php echo $category['cat_id'];?>"><?php echo $category['b_name'];?></option>
			<?php   }?>
		  </select><br>
