      ...
      <nav class="main-nav float-right d-none d-lg-block">
        <ul>
          ...
          <li class="drop-down"><a href="">Login</a>
            <ul>
              <li><a href="../admin_login/a_login.php">ADMIN</a></li>

              <li><a href="../moderator_login/m_login.php">Moderator</a></li>
  ...
  <section id="intro" class="clearfix">
    <div class="container">
      ...
      <div class="intro-info">
        <h2>MCQ Bank<br>Exam</h2>
        <div>
          <a href="../sign_in.php" class="btn-get-started scrollto">Login</a>
          <a href="../sign_up.php" class="btn-services scrollto">Registration</a>
        </div>
      </div>
    ...
    <section id="team">
      <div class="container">
        <div class="section-header">
          <h3>Team</h3>
          <p>We are working together in this project</p>
        </div>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-newsletter">
            ...
            <p>This is the project of cse411.</p>
