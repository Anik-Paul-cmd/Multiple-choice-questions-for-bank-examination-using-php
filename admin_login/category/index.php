...
<html>
	...
	<body>
		<div class="container">
			<br />
			<br />
			<h2 align="center">Select Bank Category</h2><br />
			<div align="right">
...
$(document).ready(function(){
	...
	function add_dynamic_input_field(count)
	{
		...
		output += '<td><input type="text" name="cat_name[]" placeholder="ADD Bank Category" class="form-control name_list" /></td>';
	...
	$(document).on('click', '.edit', function(){
		...
		$.ajax({
			...
			{
				$('#name').val(data.name);
				$('#dynamic_field').html(data.cat_name);
				$('#action').val('edit');
