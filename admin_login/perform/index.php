...
<html>
	...
	<body>
		<div class="container">
			<br />
			<br />
			<h2 align="center">Select Moderator</h2><br />
			<div align="right">
			...
			<form method="post" id="add_name">
				...
				<div class="modal-body">
					<div class="form-group">
		      			<input type="text" name="email" id="email" class="form-control" placeholder="Enter your name" />
		      		</div>
...
$(document).ready(function(){
	...
	function add_dynamic_input_field(count)
	{
		...
		output += '<td><input type="text" name="password[]" placeholder="ADD Password" class="form-control name_list" /></td>';
	...
	$(document).on('click', '.edit', function(){
		...
		$.ajax({
			...
			{
				$('#name').val(data.name);
				$('#dynamic_field').html(data.password);
				$('#action').val('edit');
